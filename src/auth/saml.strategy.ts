...
export class SamlStrategy extends PassportStrategy(Strategy) {
  constructor() {
    super({
      issuer: 'icdvn',
      callbackUrl: 'http://localhost:3000/api/auth/sso/saml/login/callback',
      ...
      logoutCallback: 'http://localhost:3000/api/auth/sso/saml/logout/callback',
      wantAssertionsSigned: true,
    });

    this._logoutVerify = async () => {
